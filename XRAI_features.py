...
# XRAI feature
def xrai_features(model, train_data, test_data_sample, target_feature):
	'''
	...
	'''
	param identity_feature_name: Name of the feature which helps to uniquely identify a row or 
								instance in user input dataset. 
	...
	''' 
	rai_insights = RAIInsights(model, train_data, test_data_sample, target_feature, 'classification',categorical_features=[])
